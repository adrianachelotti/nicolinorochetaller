...
void crearPaletas(Pad* pad,Pad* pad1)
{
	...
	while( it != listaFiguras.end()) 
	{
		...
		//si encontramos pad en el id es un pad...
		found = id.find("pad1");
...
int creacionEscenario()
{
	...
	//	nombre = "niveles/nivel1.esc";

		nombreEr = "errores/errores1.err";
		nombre = "archivos/nivel1.esc";
	}
 	if (contador == 2)
	{
	...
	if (archivo == NULL)
	{
		cout<<"No se pudo abrir el archivo de nivel:"<<contador<<endl;
