...
public:
	...
	bool hayChoqueConTriangulo(Tejo* pTejo, Triangulo*  triangulo,float deltaTime);
	...
	void resolverChoqueDispersores(Pad* pad, Pad* pad1, Tejo* pTejo,Escenario* escenario, float deltaTime);
