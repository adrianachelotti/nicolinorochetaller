...
int crearPantalla()
{
	...
	char nombreEr[100] = "errores\\errores.err";
	char nombre[100] = "archivos\\nivel1.esc";

	//char nombreEr[100] = "Debug\\errores\\errores.err";
	//char nombre[100] = "Debug\\archivos\\nivel1.esc";
...
DWORD WINAPI recvFilesFunction(LPVOID param) 
{
	...
	printf("Cantidad de archivos: %d ",cantidadArchivos);
...
int main(int argc, char* argv[])
{
	...
	cout<<"Iniciando transferencia archivos..."<<endl;
	...
	bool iniciar = false;
	char cadenaInitGame[4];

	while(!iniciar)
	{
		recv(pConexion->socketAccept,cadenaInitGame,sizeof(int),0);
		int inicioJuego  = *(int*)cadenaInitGame;
